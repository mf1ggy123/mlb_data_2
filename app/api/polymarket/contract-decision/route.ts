...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🎯 Frontend received contract decision request:', {
    ...
    const response = await fetch(`${pythonBackendUrl}/contract_decision`, {
      method: 'POST',
      headers: {
    ...
    console.log('✅ Contract decision analysis completed:', {
    ...
    console.error('❌ Contract decision API error:', error);
